...
@Configuration
@EnableJpaRepositories("com.greenbird.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.greenbird.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("com.greenbird.domain");
        return basePackages;
    }
