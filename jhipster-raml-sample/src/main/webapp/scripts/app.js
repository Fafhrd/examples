...
var sampleApp = angular.module('sampleApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'sampleAppUtils', 'pascalprecht.translate', 'truncate']);
